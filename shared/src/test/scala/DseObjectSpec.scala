...
"""
  ...
  it should "build a DsePassage from a CiteObject" in {
    ...
    assert(dsePsg.urn == Cite2Urn("urn:cite2:hmt:dse.v1:311r.main1"))
    assert(dsePsg.label == "Main scholion 1, 311 recto")
    assert(dsePsg.passage == CtsUrn("urn:cts:greekLit:tlg5026.msA.hmt:24.A2"))
    assert(dsePsg.imageroi == Cite2Urn("urn:cite2:hmt:vaimg.2017a:VA311RN_0481@0.216,0.0811,0.61,0.0751"))
    assert(dsePsg.surface == Cite2Urn("urn:cite2:hmt:msA.v1:311r"))
